...
class SettingsDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        engine_tip = TooltipButton(
            ...
            "better. The perceptual and saturation renderings follow their own "
            "maths: measured against colprof's they differ by about as much as "
            "two professional profiling tools differ from each other, so "
            "prints look right but not pixel-identical to a colprof build. "
            "For multi-ink printers, treat the first profiles as working "
            "profiles: verify with a test print before a big production run.\n\n"
